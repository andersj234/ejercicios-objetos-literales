let nombrePersona = window.prompt('¿que nombre quieres que te muestre?')
 let personas = {
    BridgetteMcGuire: {
  ...
  if(nombrePersona === personas.BridgetteMcGuire.gender){
      document.getElementById("div").innerHTML =`<h1>${nombrePersona}</h1>`
  }else if(nombrePersona === personas.BridgetteMcGuire.about){
      document.getElementById("div").innerHTML =`<h1>${nombrePersona}</h1>`
  } else{ document.getElementById("div").innerHTML =`<h1>No encuentro ningún dato dentro de mi</h1>`}// esto es mas para el 5

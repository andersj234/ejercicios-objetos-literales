let nacimiento = parseInt(window.prompt('cual es tu fecha de nacimiento'))
let nombre =window.prompt('¿Como te llamas?')
let apellido =window.prompt('¿como te apellidas?').charAt(apellido.length-1)
console.log(apellido)
let masculinopregunta =window.prompt('¿quieres el nombre en masculino o en femenino?')
